...
export default function PricingPage() {
    ...
    const getPrice = (plan: PricingPlan) => {
        if (billingCycle === "annual") {
            // Custom logic: 570 ZMW/month for annual billing
            return "570.00";
        }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                ...
                <div className="flex items-center justify-center gap-4 mb-12">
                    ...
                    <span className={`text-sm font-medium ${billingCycle === "annual" ? "text-slate-900 dark:text-white" : "text-slate-500"}`}>
                        Annual <span className="text-green-600">(Save 5%)</span>
                    </span>
                </div>

                {/* Pricing Cards */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto lg:flex lg:justify-center">
                    {plans.map((plan) => {
                        ...
                        return (
                            <div
                                key={plan.key}
                                className={`relative bg-white dark:bg-slate-800 rounded-2xl border-2 transition-all hover:scale-105 w-full max-w-sm ${plan.popular
