    ...
    useEffect(() => {
        const fetchProfile = async () => {
            if (user) {
                ...
                // Fetch full profile to get tenant_id
                try {
                    // Since we don't have authFetch readily available here without importing
                    // and we want tenant_id.
                    // Helper:
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <LencoPayButton
                                ...
                                tenantId={userProfile?.tenant_id || "unknown"}
