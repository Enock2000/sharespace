...
export interface B2FileUploaderRef {
    handleFiles: (files: FileList | File[]) => void;
}

const B2FileUploader = forwardRef<B2FileUploaderRef, {
    currentFolderId: string | null,
    onUploadComplete: () => void
}>(({ currentFolderId, onUploadComplete }, ref) => {
...
B2FileUploader.displayName = "B2FileUploader";
